...
export const HORIZON_FRAME_KEYS: FrameKey[] = [
  'horizonScanner',
  'horizonRadar',
  'horizonObserver',
  'horizonHeatmap',
...
export const MAIN_FRAME_KEYS: FrameKey[] = ALL_FRAME_KEYS.filter(
  (k) => !HORIZON_FRAME_KEYS.includes(k),
);

export function getFrameKeysForTab(tab: DashboardTab): FrameKey[] {
  return tab === 'horizon' ? HORIZON_FRAME_KEYS : MAIN_FRAME_KEYS;
}
...
export const DEFAULT_LAYOUT_ITEMS: Record<string, LayoutItem[]> = {
  lg: [
    ...
    { i: 'horizonScanner',   x: 0, y: 0, w: 14, h: 12, minW: 10, minH: 6 },
    { i: 'horizonRadar',     x: 14, y: 0, w: 10, h: 12, minW: 6, minH: 6 },
    { i: 'horizonObserver',  x: 0, y: 12, w: 14, h: 8, minW: 8, minH: 4 },
    { i: 'horizonHeatmap',   x: 14, y: 12, w: 10, h: 8, minW: 6, minH: 4 },
  ],
  md: [
    ...
    { i: 'horizonScanner',   x: 0, y: 0, w: 16, h: 12, minW: 10, minH: 6 },
    { i: 'horizonRadar',     x: 0, y: 12, w: 8, h: 10, minW: 6, minH: 6 },
    { i: 'horizonObserver',  x: 8, y: 12, w: 8, h: 10, minW: 8, minH: 4 },
    { i: 'horizonHeatmap',   x: 0, y: 22, w: 16, h: 8, minW: 6, minH: 4 },
  ],
  sm: [
    ...
    { i: 'horizonScanner',   x: 0, y: 0, w: 8, h: 12, minW: 4, minH: 6 },
    { i: 'horizonRadar',     x: 0, y: 12, w: 8, h: 10, minW: 4, minH: 4 },
    { i: 'horizonObserver',  x: 0, y: 22, w: 8, h: 8, minW: 4, minH: 4 },
    { i: 'horizonHeatmap',   x: 0, y: 30, w: 8, h: 8, minW: 4, minH: 4 },
  ],
};
...
export interface LayoutStore {
  ...
  // Dashboard tab
  activeDashboard: DashboardTab;
  setActiveDashboard: (tab: DashboardTab) => void;
...
export const useLayoutStore = create<LayoutStore>((set, get) => ({
  activeDashboard: 'main' as DashboardTab,
  setActiveDashboard: (tab) => set({ activeDashboard: tab }),
